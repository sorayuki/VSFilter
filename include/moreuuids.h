...
MPC_GUID_ENTRY(MEDIASUBTYPE_Y116,
...
MPC_GUID_ENTRY(CLSID_MPCVRAllocatorPresenter,
...
MPC_GUID_ENTRY(CLSID_AssFilterModAutoLoad,
...
MPC_GUID_ENTRY(CLSID_ffdshowRawVideoFilter,
